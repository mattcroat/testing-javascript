...
export default function Calculator() {
  let [state, setState] = React.useReducer(calcReducer, {
    value: null,
    displayValue: '0',
    operator: null,
    waitingForOperand: false,
  })
  let { value, displayValue, operator, waitingForOperand } = state
  ...
  let displayIsNonZero = displayValue !== '0'
  let clearText = displayIsNonZero ? 'C' : 'AC'
